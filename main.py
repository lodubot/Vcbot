...
def register_handlers(app: Client):
    ...
    async def otp_cmd(client, message: Message):
        ...
        try:
            ...
            await msg.edit_text("✅ Login Successful! Account save ho gaya hai. Service restart karke Userbot active karein.")
    ...
    async def pass_cmd(client, message: Message):
        ...
        try:
            ...
            await msg.edit_text("✅ Login Successful with 2FA! Account save ho gaya hai.")
